...
const Stepper = ({ currentStep }: StepperProps) => {
  ...
  return (
    <div className="flex items-center w-full p-3 space-x-2 text-sm font-medium text-center text-gray-500 rounded-lg dark:text-gray-400 sm:text-base sm:p-4 sm:space-x-4">
