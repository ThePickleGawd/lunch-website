...
const Metadata = () => {
  return (
    <Head>
      <title>
        LunchTrak: Automatic Wireless Check-in Technology - 10x Faster Lunch
        Lines
      </title>
      <meta
        name="description"
      ...
      <meta
        property="og:title"
        content="LunchTrak: Automatic Wireless Check-in Technology - 10x Faster Lunch Lines"
      />
      <meta
      ...
      <meta
        property="og:image"
        content="https://www.lunchtrak.com/img/lunchtrak/LunchTrakGraphic.jpg"
      />
